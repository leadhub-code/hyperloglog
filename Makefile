...
check: $(venv_dir)/packages-installed
	g++ -g -std=c++14 -O4 -Wall -Wextra  hll/murmur.cxx tests/test_serialization.cpp -o test_serialization && ./test_serialization
	rm test_serialization
	g++ -g -std=c++14 -O4 -Wall -Wextra  hll/murmur.cxx tests/test_count.cpp -o test_count && ./test_count
	rm test_count
